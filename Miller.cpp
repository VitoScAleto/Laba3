...
int main() 
{
    ...
    vector<int> res;// кол-во чисел для проверки
    vector<string> res_ver_test;// результат вероятностного теста
    vector<int> otvegnutie;//отвергнутые числа
...
// тест миллера(по усл)
    bool isValidAllResultOne = true;
    int i = 0;
    for (int aj : a) // пункт 3
    {
